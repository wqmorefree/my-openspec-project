package com.openspec.project.web.controller;
...
import com.openspec.project.common.core.enums.PushSourceEnum;
import com.openspec.project.common.core.enums.PushTypeEnum;
import com.openspec.project.common.core.utils.DateUtils;
...
import com.openspec.project.common.encrypt.annotation.ApiEncrypt;
...
import com.openspec.project.common.social.config.properties.SocialLoginConfigProperties;
import com.openspec.project.common.social.config.properties.SocialProperties;
import com.openspec.project.common.social.utils.SocialUtils;
import com.openspec.project.system.api.MessageService;
import com.openspec.project.system.api.domain.PushPayloadDTO;
import com.openspec.project.system.api.model.RegisterBody;
import com.openspec.project.system.api.model.SocialLoginBody;
import com.openspec.project.system.domain.vo.SysClientVo;
import com.openspec.project.system.service.ISysClientService;
import com.openspec.project.system.service.ISysConfigService;
...
import com.openspec.project.web.service.SysRegisterService;
...
public class AuthController {
    ...
    /**
     * 登录密码 SM2 传输加密公钥（Base64）。
     */
    @Value("${security.crypto.sm2.publicKey}")
    private String sm2PublicKey;


    /**
     * 获取 SM2 公钥（供前端 sm-crypto 加密登录密码）。
     *
     * @return HEX 格式 SM2 公钥（04||x||y）
     */
    @GetMapping("/public-key")
    public R<String> getPublicKey() {
        return R.data(EncryptUtils.getSm2PublicKeyHex(sm2PublicKey));
    }
